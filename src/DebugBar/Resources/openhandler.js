    ...
    PhpDebugBar.OpenHandler = PhpDebugBar.Widget.extend({
        ...
        addSearch: function(){
            ...
            $('<form />')
                ...
                .append('Status Code: <input type="text" name="status_code" value="" style="width: 150px"><br/>')
                .append('Request Time Start: <input type="text" name="req_start_date_time" value="" style="width: 150px"> eg: '+startTime+'<br/>')
                ...
                .append('Uri: <input placeholder="support regex" type="text" name="uri" style="width: 300px"><br/>')
                .append('Sql: <input title="many keyword in a sql connected by & eg: user=2&mobile=10086" placeholder="support regex " type="input" name="sql" style="width: 300px"><br/>')
